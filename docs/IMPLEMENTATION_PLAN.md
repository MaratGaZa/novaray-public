...
81. [x] Запрет повторов критичных параметров VLESS URI — issue #132, PR #133:
    ...
    неизвестные ключи и корректные одиночные параметры сохраняют прежний контракт.
    Проверки: матрица ключей/значений/порядка, внешний потребитель, мутации, default/feature,
