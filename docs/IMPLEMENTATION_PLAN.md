...
| 71 | `[ ]` | Допуск bootstrap и выбор первого endpoint | Реализует чистую начальную модель допуска, ограниченного ответа и однократного выбора с проверкой срока/контекста; resolver и системные действия не выполняет. | [#112](https://github.com/MaratGaZa/novaray-public/issues/112) | TBD |

После слияния PR #111 протокол задачи 70 находится в `main`. Текущая задача 71 / issue #112:
...
71. [ ] Допуск bootstrap и выбор первого endpoint — issue #112, PR TBD:
