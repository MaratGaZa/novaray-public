...
Пункт 62 описывает текущую документационную ревизию [#94](https://github.com/MaratGaZa/novaray-public/issues/94).
Следующая задача после неё пока не утверждена; её номер, объём и критерии приёмки нужно определить
