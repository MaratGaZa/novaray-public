...
значения не являются исключением. Ошибка повтора содержит только категорию и каноническое имя,
без URI, значений или адреса сервера. Разные alias сохраняют прежнюю проверку конфликтов;
