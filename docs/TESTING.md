...
- macOS helper install/deinstall executor: validated Gate I plans execute through a typed platform
  ...
  stop-state diagnostics, and recording adapters prove no source reopen or shell interpolation;
